...
def main():
    ...
    model.train(
        ...
        cls=0.2,             # 默认 0.5 → 降低，背景远多于前景，避免 cls_loss 主导
        dfl=1.5,             # 默认 1.5，保持不变
        ...
        # ---- 其他优化 ----
        label_smoothing=0.1, # 标签平滑，防止过拟合（小数据集有效）
